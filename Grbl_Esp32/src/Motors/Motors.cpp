...
void init_motors() {
    ...
    myMotor[X_AXIS][0] = new Motors::RcServo(X_AXIS, X_SERVO_PIN, SERVO_DEFAULT_MIN_CAL, SERVO_DEFAULT_MAX_CAL);
    ...
    myMotor[X_AXIS][1] = new Motors::RcServo(X2_AXIS, X2_SERVO_PIN, SERVO_DEFAULT_MIN_CAL, SERVO_DEFAULT_MAX_CAL);
    ...
    myMotor[Y_AXIS][0] = new Motors::RcServo(Y_AXIS, Y_SERVO_PIN, SERVO_DEFAULT_MIN_CAL, SERVO_DEFAULT_MAX_CAL);
    ...
    myMotor[Y_AXIS][1] = new Motors::RcServo(Y2_AXIS, Y2_SERVO_PIN, SERVO_DEFAULT_MIN_CAL, SERVO_DEFAULT_MAX_CAL);
    ...
    myMotor[Z_AXIS][0] = new Motors::RcServo(Z_AXIS, Z_SERVO_PIN, SERVO_DEFAULT_MIN_CAL, SERVO_DEFAULT_MAX_CAL);
    ...
    myMotor[Z_AXIS][1] = new Motors::RcServo(Z2_AXIS, Z2_SERVO_PIN, SERVO_DEFAULT_MIN_CAL, SERVO_DEFAULT_MAX_CAL);
    ...
    myMotor[A_AXIS][1] = new Motors::RcServo(A2_AXIS, A2_SERVO_PIN, SERVO_DEFAULT_MIN_CAL, SERVO_DEFAULT_MAX_CAL);
    ...
    myMotor[B_AXIS][0] = new Motors::RcServo(B_AXIS, B_SERVO_PIN, SERVO_DEFAULT_MIN_CAL, SERVO_DEFAULT_MAX_CAL);
    ...
    myMotor[B_AXIS][1] = new Motors::RcServo(B2_AXIS, B2_SERVO_PIN, SERVO_DEFAULT_MIN_CAL, SERVO_DEFAULT_MAX_CAL);
    ...
    myMotor[C_AXIS][0] = new Motors::RcServo(C_AXIS, C_SERVO_PIN, SERVO_DEFAULT_MIN_CAL, SERVO_DEFAULT_MAX_CAL);
    ...
    myMotor[C_AXIS][1] = new Motors::RcServo(C2_AXIS, C2_SERVO_PIN, SERVO_DEFAULT_MIN_CAL, SERVO_DEFAULT_MAX_CAL);
